...
('Precision-Led, Personal Fitness Design', 'We start by understanding your body, then design a routine tailored to how you move, recover, and grow.', '/images/why-bfriends/1.jpg', 0),
('One Standard, One System of Care', 'Our trainers, therapists, and K-Beauty specialists work under a shared standard. Ensuring consistency, clarity, and quality in every experience.', '/images/why-bfriends/2.jpg', 1),
('Your Dedicated Journey Partner', 'From your first visit to ongoing progress, one dedicated partner guides your experience and supports you every step of the way.', '/images/why-bfriends/3.jpg', 2),
('You Can See and Track', 'From baseline to milestones, your journey is recorded and refined—so progress is clear, not just felt.', '/images/why-bfriends/4.jpg', 3),
('One Space, One Continuous Flow', 'Fitness, recovery, therapy, and beauty come together in one place—supporting a complete and connected wellness journey.', '/images/why-bfriends/5.jpg', 4);

-- ============================================================
-- 5. Process Steps + Subpoints
-- ============================================================
INSERT INTO bfriends_process_steps (number, title, description, image, sort_order) VALUES
('01', 'Measure', 'Our ''Reading'' process gathers the essentials to start the healing journey for ever lasting wellness.', '/images/Fitness/DDK09594.webp', 0),
('02', 'Assess', 'Our Journey Partners will translate your measurement into clear steps, identifying the balance way and priorities your health needs to return to its wellness.', '/images/Integrate/DDK09193.jpg', 1),
('03', 'Design', 'We illustrate your unique healing FRIEND Fitness flow. Your steps is layered into structure, recovery, and intensity, specific only to your wellness and current condition.', '/images/Enhance/DDK00330.jpg', 2),
('04', 'Teacher/Coach/Guides', 'Recovery requires detailed steps. We guide you through the BFriends steps, ensuring every healing and balance steps is prepared with high-standard intention.', '/images/Restore/DDK00016.webp', 3),
('05', 'Track', 'Progress has never left to chance. We continuously keep, hold, and review your healing response to the fitness flow, ensuring balance and wellness becomes a daily habit.', '/images/Integrate/DDK09558.jpg', 4),
('06', 'Refine', 'As your body improves, your plans too. We adjust your routine to ensure your journey remains a safe, enjoyable and achievable one, in line with your continually developing capability.', '/images/Enhance/DDK00601.jpg', 5);
